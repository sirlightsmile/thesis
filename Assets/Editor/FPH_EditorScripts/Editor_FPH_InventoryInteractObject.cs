...
public class Editor_FPH_InventoryInteractObject : Editor {
	...
	public override void OnInspectorGUI(){
		...
		if(language == "English"){
			...
			myInspector.obtainMessage_English = EditorGUILayout.TextField(myInspector.obtainMessage_English, GUILayout.Height(50.0f), GUILayout.MinWidth(60.0f));
			EditorGUI.indentLevel = 0;
			
			EditorGUILayout.LabelField("Description Text (English):");
			EditorGUI.indentLevel = 5;
			myInspector.description_English = EditorGUILayout.TextField(myInspector.description_English, GUILayout.Height(50.0f), GUILayout.MinWidth(60.0f));
			EditorGUI.indentLevel = 0;
		}
		if(language == "Italian"){
			EditorGUILayout.LabelField("Obtain Text (Italian):");
			EditorGUI.indentLevel = 5;
			myInspector.obtainMessage_Italian = EditorGUILayout.TextField(myInspector.obtainMessage_Italian, GUILayout.Height(50.0f), GUILayout.MinWidth(60.0f));
			EditorGUI.indentLevel = 0;
			
			EditorGUILayout.LabelField("Description Text (Italian):");
			EditorGUI.indentLevel = 5;
			myInspector.description_Italian = EditorGUILayout.TextField(myInspector.description_Italian, GUILayout.Height(50.0f), GUILayout.MinWidth(60.0f));
			EditorGUI.indentLevel = 0;
		}
		if(language == "Spanish"){
			EditorGUILayout.LabelField("Obtain Text (Spanish):");
			EditorGUI.indentLevel = 5;
			myInspector.obtainMessage_Spanish = EditorGUILayout.TextField(myInspector.obtainMessage_Spanish, GUILayout.Height(50.0f), GUILayout.MinWidth(60.0f));
			EditorGUI.indentLevel = 0;
			
			EditorGUILayout.LabelField("Description Text (Spanish):");
			EditorGUI.indentLevel = 5;
			myInspector.description_Spanish = EditorGUILayout.TextField(myInspector.description_Spanish, GUILayout.Height(50.0f), GUILayout.MinWidth(60.0f));
			EditorGUI.indentLevel = 0;
		}
		if(language == "German"){
			EditorGUILayout.LabelField("Obtain Text (German):");
			EditorGUI.indentLevel = 5;
			myInspector.obtainMessage_German = EditorGUILayout.TextField(myInspector.obtainMessage_German, GUILayout.Height(50.0f), GUILayout.MinWidth(60.0f));
			EditorGUI.indentLevel = 0;
			
			EditorGUILayout.LabelField("Description Text (German):");
			EditorGUI.indentLevel = 5;
			myInspector.description_German = EditorGUILayout.TextField(myInspector.description_German, GUILayout.Height(50.0f), GUILayout.MinWidth(60.0f));
			EditorGUI.indentLevel = 0;
		}
		if(language == "French"){
			EditorGUILayout.LabelField("Obtain Text (French):");
			EditorGUI.indentLevel = 5;
			myInspector.obtainMessage_French = EditorGUILayout.TextField(myInspector.obtainMessage_French, GUILayout.Height(50.0f), GUILayout.MinWidth(60.0f));
			EditorGUI.indentLevel = 0;
			
			EditorGUILayout.LabelField("Description Text (French):");
			EditorGUI.indentLevel = 5;
			myInspector.description_French = EditorGUILayout.TextField(myInspector.description_French, GUILayout.Height(50.0f), GUILayout.MinWidth(60.0f));
			EditorGUI.indentLevel = 0;
		}
		if(language == "Chinese"){
			EditorGUILayout.LabelField("Obtain Text (Chinese):");
			EditorGUI.indentLevel = 5;
			myInspector.obtainMessage_Chinese = EditorGUILayout.TextField(myInspector.obtainMessage_Chinese, GUILayout.Height(50.0f), GUILayout.MinWidth(60.0f));
			EditorGUI.indentLevel = 0;
			
			EditorGUILayout.LabelField("Description Text (Chinese):");
			EditorGUI.indentLevel = 5;
			myInspector.description_Chinese = EditorGUILayout.TextField(myInspector.description_Chinese, GUILayout.Height(50.0f), GUILayout.MinWidth(60.0f));
			EditorGUI.indentLevel = 0;
		}
		if(language == "Japanese"){
			EditorGUILayout.LabelField("Obtain Text (Japanese):");
			EditorGUI.indentLevel = 5;
			myInspector.obtainMessage_Japanese = EditorGUILayout.TextField(myInspector.obtainMessage_Japanese, GUILayout.Height(50.0f), GUILayout.MinWidth(60.0f));
			EditorGUI.indentLevel = 0;
			
			EditorGUILayout.LabelField("Description Text (Japanese):");
			EditorGUI.indentLevel = 5;
			myInspector.description_Japanese = EditorGUILayout.TextField(myInspector.description_Japanese, GUILayout.Height(50.0f), GUILayout.MinWidth(60.0f));
			EditorGUI.indentLevel = 0;
		}
		if(language == "Russian"){
			EditorGUILayout.LabelField("Obtain Text (Russian):");
			EditorGUI.indentLevel = 5;
			myInspector.obtainMessage_Russian = EditorGUILayout.TextField(myInspector.obtainMessage_Russian, GUILayout.Height(50.0f), GUILayout.MinWidth(60.0f));
			EditorGUI.indentLevel = 0;
			
			EditorGUILayout.LabelField("Description Text (Russian):");
			EditorGUI.indentLevel = 5;
			myInspector.description_Russian = EditorGUILayout.TextField(myInspector.description_Russian, GUILayout.Height(50.0f), GUILayout.MinWidth(60.0f));
			EditorGUI.indentLevel = 0;
		}
